...
- [stablyai/orca](https://github.com/stablyai/orca) ([v1.4.198](https://github.com/stablyai/orca/releases/tag/v1.4.198), about 12 hours ago) - Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop, mobile and remote runtime.
- [n8n-io/n8n](https://github.com/n8n-io/n8n) ([beta](https://github.com/n8n-io/n8n/releases/tag/beta), about 12 hours ago) - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
- [wickenico/WailBrew](https://github.com/wickenico/WailBrew) ([v0.12.1](https://github.com/wickenico/WailBrew/releases/tag/v0.12.1), 4 days ago) - Minimalistic Homebrew GUI made with Go, Wails and React.
