...
- [stablyai/orca](https://github.com/stablyai/orca) ([v1.4.145-rc.3](https://github.com/stablyai/orca/releases/tag/v1.4.145-rc.3), about 1 hour ago) - Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with your own subscription. Available on desktop and mobile.
- [n8n-io/n8n](https://github.com/n8n-io/n8n) ([n8n@1.123.66](https://github.com/n8n-io/n8n/releases/tag/n8n%401.123.66), about 18 hours ago) - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
...
- [open-telemetry/opentelemetry-collector-contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib) ([v0.155.0](https://github.com/open-telemetry/opentelemetry-collector-contrib/releases/tag/v0.155.0), 24 days ago) - Contrib repository for the OpenTelemetry Collector
